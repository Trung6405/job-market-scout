...
def test_join_match_results_pairs_listing_with_its_score():
    ...
    scores = [ListingScore(external_id="1", score=82, reasoning="Strong overlap.")]
...
def test_join_match_results_ignores_hallucinated_external_ids():
    listings = [_make_listing(external_id="1")]
    scores = [
        ListingScore(external_id="1", score=82, reasoning="Strong overlap."),
        ListingScore(external_id="does-not-exist", score=50, reasoning="Invented."),
    ]
